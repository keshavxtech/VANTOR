...
export default function LoginPage() {  const [email, setEmail] = useState("");
  ...
  return <AuthShell>
    ...
    <form onSubmit={submit} className="space-y-4">
      ...
      <button disabled={loading} className="w-full rounded-lg bg-[#7C3AED] hover:bg-[#6D28D9] disabled:opacity-50 py-2.5 text-sm font-medium">{loading ? "Signing inâ€¦" : "Sign In"}</button>
    </form>
